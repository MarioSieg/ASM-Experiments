...
main:
    ...
    movss %xmm0, %xmm1      # copy 64-bit scalar from xmm0 to xmm1
    movss %xmm0, %xmm2      # copy 64-bit scalar from xmm0 to xmm2
    addss %xmm2, %xmm2      # add 64-bit scalar from xmm2 to xmm2 and store in xmm2
    ...
    movss %xmm0, %xmm1      # copy 64-bit scalar from xmm0 to xmm1
    movss %xmm0, %xmm2      # copy 64-bit scalar from xmm0 to xmm2
    mulss %xmm2, %xmm2      # multiply 64-bit scalar from xmm2 with xmm2 and store in xmm2
    cvtss2sd %xmm0, %xmm0   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm1, %xmm1   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm2, %xmm2   # convert 32-bit single to 64-bit double
    ...
    movss %xmm0, %xmm1      # copy 64-bit scalar from xmm0 to xmm1
    movss %xmm0, %xmm2      # copy 64-bit scalar from xmm0 to xmm2
    subss %xmm2, %xmm2      # multiply 64-bit scalar from xmm2 with xmm2 and store in xmm2
    cvtss2sd %xmm0, %xmm0   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm1, %xmm1   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm2, %xmm2   # convert 32-bit single to 64-bit double
    ...
    movss %xmm0, %xmm1      # copy 64-bit scalar from xmm0 to xmm1
    movss %xmm0, %xmm2      # copy 64-bit scalar from xmm0 to xmm2
    divss %xmm2, %xmm2      # multiply 64-bit scalar from xmm2 with xmm2 and store in xmm2
    cvtss2sd %xmm0, %xmm0   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm1, %xmm1   # convert 32-bit single to 64-bit double
    cvtss2sd %xmm2, %xmm2   # convert 32-bit single to 64-bit double
